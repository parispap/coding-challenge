...
const GameBoard =(props)=> {
    ...
    for (let i=0;i<number_of_cards;i++) {
        card_array.push(
            <Card card_value={props.card_properties.value[i]} card_face={props.card_properties.card_face[i]}/>
            ...
            {card_array}
                ...
                <div className={styles.button_row}>
                    <button onClick={(e)=>{
                        ...
                        props.hide_cards(props.card_properties)}}}>Play</button>
...
const mapDispatchToProps = (dispatch) => {
    return {
        hide_cards: (card_properties)=> {dispatch(hide_cards(card_properties))},
        forfeit: ()=>{dispatch(forfeit())}
    }
}
